...
<body class="cms-index-index cms-home-page">
    <div id="page">
        <!-- Header -->
        <header>
            <div class="header-container" style="background-color: #800000;">
                <div class="container" style="background-color: #800000;">
                    <div class="row" style="background-color: #800000;">
                        <!-- Header Language -->
                        <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left" style="background-color: #800000;">
                            <div class="dropdown block-language-wrapper" style="background-color: #800000;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 logo-block">
                        ...
                        <div class="logo">
                            <a title="Linea HTML Template" href="{{ route('home') }}"><img alt="Linea HTML"
                                    src="{{ asset('frontend/images/canv.png') }}"> </a>
                        </div>
                        </div>
                        <!-- End Header Logo -->
                    </div>
            ...
            <nav class="hidden-xs" style="background-color: #800000;">
                <div class="nav-container" style="background-color: #800000;">
                    <div class="col-md-3 col-xs-12 col-sm-4">
                        <div class="mega-container visible-lg visible-md visible-sm">
                            <div class="navleft-container" style="background-color: #800000;">
                                <div class="mega-menu-title" id="mega-menu-title" style="background-color: #FF9900;">
                                ...
                                <div class="mega-menu-category" id="mega-menu-category"
                                    ...
                                    <ul class="nav">
                                        ...
                                        class="fa fa-home"></i> Trang chủ</a>
                                         ...
                                         <li><a href="http://127.0.0.1:8000/wishlist"><i class="fa fa-file-text"></i> Sản phẩm yêu thích</a>
                    ...
                    <!-- features box -->
                    <div class="our-features-box hidden-xs" style="background-color: red;">
                        <div class="features-block" style="background-color: red;">
                        ...
                        <div class="col-md-3 col-sm-6">
                         ...
                         <div class="col-md-3 col-sm-6">
                             ...
                             <div class="contacts-info">
                                 ...
                                 <div class="phone-footer"><i class="phone-icon">&nbsp;</i> 0123456789
                                 </div>
                                 <div class="email-footer"><i class="email-icon">&nbsp;</i> <a
                                         href="mailto:caomanhcuong@gmail.com">caomanhcuong@gmail.com</a> </div>
                             </div>
                        </div>
                    </div>
                </div>
