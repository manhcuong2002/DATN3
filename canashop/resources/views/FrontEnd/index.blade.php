            ...
            <aside class="col-left sidebar col-md-3 col-sm-4 col-xs-12 col-sm-pull-8 col-md-pull-9">
                                ...
                                <div id="carousel-example-generic" class="carousel slide"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active"> <img
                                                src="{{ asset('frontend/images/cus1.jpg') }}"
                                                alt="slide3">
                                        ...
                                        <div class="item"> <img
                                                src="{{ asset('frontend/images/cus2.jpg') }}"
                                                alt="slide2">
                            ...
                            <div id="testimonials-slider"
                                ...
                                <div class="slider-items slider-width-col4 fadeInUp">
                                    <div class="holder">
                                        ...
                                        <p>Wow, tôi không thể không khen shop quần áo này! Tôi đã có trải nghiệm mua sắm tuyệt vời tại đây. Sự đa dạng và phong cách của sản phẩm thật sự đáng ngạc nhiên. Chất liệu cao cấp và thiết kế tinh tế làm cho từng món đồ trở nên độc đáo và phong cách. .</p>
                                        <div class="line"></div>
                ...
                <div class="featured-add-box">
                    <div class="featured-add-inner">
                        <a href="#"> <img src="{{ asset('frontend/images/abcd.jpg') }}" alt="f-img"></a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="entry-thumb image-hover2">
                        <a href="blog_single_post.html"> <img alt="Blog"
                                src="{{ asset('frontend/images/blog.jpg') }}" width="550px" height="255.46px"> </a>
                    </div>
                    <div class="blog-preview_info">
                    <h4 class="blog-preview_title"><a href="blog_single_post.html">Trời trang mang xu hướng xưa</a></h4>
                         <ul class="post-meta">
                         ...
                         <div class="blog-preview_desc">Người trẻ hiện nay cùng với phong cách "ngược dòng thời trang", mang phong cách độc đáo cũng như nhớ về những nét đẹp xưa cũ.</div>
                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6">
                     <div class="entry-thumb image-hover2">
                         <a href="blog_single_post.html"> <img alt="Blog"
                         src="{{ asset('frontend/images/blog2.jpg') }}" width="550px" height="255.46px"> </a>
                     </div>
                     <div class="blog-preview_info">
                         <h4 class="blog-preview_title"><a href="blog_single_post.html">Phái đẹp ngoài kia họ mặc gì?</a></h4>
                         <ul class="post-meta">
                             <li><i class="fa fa-user"></i>được đăng bởi <a href="#">admin</a></li>
                         ...
                         <div class="blog-preview_desc">Đối với phái đẹp, việc ăn mặc những gì để bước ra đường quả là một câu hỏi khó khăn. Vậy cùng xem ngoài kia, phái đẹp chọn mặc gì ra đường?</div>
                         <a class="blog-preview_btn" href="blog_single_post.html">ĐỌC THÊM</a>
                     </div>
                </div>
            </div>
